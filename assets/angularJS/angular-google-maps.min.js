...
! function(a, b, c) {
    ...
    (function() {
        ...
        function() {
            b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapFitHelper", ["uiGmapLogger", "uiGmap_async", function(a, b) {
                return {
                    fit: function(a, b) {
                        var c, d;
        ...
        function() {
            b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapIsReady", ["$q", "$timeout", function(a, b) {
                ...
                return d = 0, h = [], e = 1, f = 50, g = function() {
                    ...
                    return b(function() {
                        return e >= f && a.reject("Your maps are not found we have checked the maximum amount of times. :)"), e += 1, d !== h ? c(a, h) : a.resolve(g())
                    }, 100)
                }, {
                    spawn: function() {
                        var b;
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapLayerParentModel", ["uiGmapBaseObject", "uiGmapLogger", "$timeout", function(d, e, f) {
                ...
                return g = function(d) {
                    ...
                    return c(f, d), f.prototype.createGoogleLayer = function() {
                        var a;
                        return null == this.attrs.options ? this.gObject = void 0 === this.attrs.namespace ? new google.maps[this.attrs.type] : new google.maps[this.attrs.namespace][this.attrs.type] : this.gObject = void 0 === this.attrs.namespace ? new google.maps[this.attrs.type](this.scope.options) : new google.maps[this.attrs.namespace][this.attrs.type](this.scope.options), null != this.gObject && null != this.onLayerCreated && "function" == typeof(a = this.onLayerCreated(this.scope, this.gObject)) ? a(this.gObject) : void 0
                    }, f
                }(d)
            }])
        }.call(this),
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapMarkersParentModel", ["uiGmapIMarkerParentModel", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapMarkerChildModel", "uiGmap_async", "uiGmapClustererMarkerManager", "uiGmapMarkerManager", "$timeout", "uiGmapIMarker", "uiGmapPromise", "uiGmapGmapUtil", "uiGmapLogger", function(d, e, f, g, h, i, j, k, l, m, n, o) {
                ...
                return q = function(a, b) {
                    ...
                    function k(b, c, d, e) {
                        ...
                        var g;
                        k.__super__.constructor.call(this, b, c, d, e), this["interface"] = l, g = this, q(new f, this), this.scope.pluralsUpdate = {
                            updateCtr: 0
